...
<body bgcolor="#FFFFFF"><center><img src="doco.png" width="100">
    <img src="pic.png" ></center> <a href="dochome.php"><img class= "top-right1"src="home.png" width="50px" height="50px"></a>
...
<body>
    ...
    <form name="repRegistration" method="post" action="addptpro.php">
            ...
            <div class="field-column">
                ...
                <div>
                    <input type="int" class="demo-input-box"
                        name="age"
                        value="<?php if(isset($_POST['age'])) echo $_POST['age']; ?>" required >
                </div>
            </div>
