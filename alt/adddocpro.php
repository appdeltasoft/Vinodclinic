...
echo "<script type='text/javascript'>setTimeout(\"location.href = 'adddoc.php';\",1500); alert('$message');</script>";
}

else {

$sql="INSERT INTO tbl_doc values('$name','$gender','Doctor','$date','$email','$phone','$address','$uname','$pwd')";
$res=mysqli_query($con,$sql);

$sqli="INSERT INTO tbl_login values('$uname','$pwd','Doctor')";
